...
class Property {
    ...
    public function __construct( array $propertyData ) {
        ...
        $this->appraisal_date                             = Carbon::parse( Helper::convertElementToString($propertyData[ 'appraisal_date' ]), Helper::CARBON_TIMEZONE ); // Ex: 2017-04-18, but I will convert to Carbon
        ...
        $this->current_occupancy_as_of_date               = Carbon::parse( Helper::convertElementToString($propertyData[ 'current_occupancy_as_of_date' ]), Helper::CARBON_TIMEZONE ); // Ex: 2020-03-31, but I will convert to Carbon
        ...
        $this->kbra_annualized_as_of_date                 = Carbon::parse( Helper::convertElementToString($propertyData[ 'kbra_annualized_as_of_date' ]), Helper::CARBON_TIMEZONE ); // Ex: 2020-06-30, but I will convert to Carbon
        ...
        $this->most_recent_as_of_date                     = Carbon::parse( Helper::convertElementToString($propertyData[ 'most_recent_as_of_date' ]), Helper::CARBON_TIMEZONE ); // Ex: 2020-06-30, but I will convert to Carbon
        ...
        $this->preceding_as_of_date                       = Carbon::parse( Helper::convertElementToString($propertyData[ 'preceding_as_of_date' ]), Helper::CARBON_TIMEZONE ); // Ex: 2019-12-31, but I will convert to Carbon
