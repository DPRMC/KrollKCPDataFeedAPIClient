...
class LoanGroup {
    ...
    public function __construct( array $loanGroup ) {
        ...
        $this->pari_deal_in_control                       = Helper::convertElementToString( $loanGroup[ 'pari_deal_in_control' ] ?? NULL );
        $this->pari_kbra_master_deal                      = Helper::convertElementToString( $loanGroup[ 'pari_kbra_master_deal' ] ?? NULL );
        $this->pari_passu_details                         = Helper::convertElementToString( $loanGroup[ 'pari_passu_details' ] ?? NULL );
