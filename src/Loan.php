...
//    public $properties;
    ...
    public function __construct( array $loanData ) {
        ...
        $this->current_noi                                = $loanData[ 'current_noi' ];
        $this->current_debt_service_amount                = $loanData[ 'current_debt_service_amount' ];
        $this->current_debt_yield_ncf                     = $loanData[ 'current_debt_yield_ncf' ];
        $this->current_occupancy                          = $loanData[ 'current_occupancy' ];
        $this->current_occupancy_as_of_date               = Carbon::parse( $loanData[ 'current_occupancy_as_of_date' ] );
        ...
        $this->most_recent_revenue                        = $loanData[ 'most_recent_revenue' ];
        $this->most_recent_expenses                       = $loanData[ 'most_recent_expenses' ];
        $this->most_recent_noi                            = $loanData[ 'most_recent_noi' ];
        $this->most_recent_ncf                            = $loanData[ 'most_recent_ncf' ];
        $this->most_recent_as_of_date                     = Carbon::parse( $loanData[ 'most_recent_as_of_date' ] );
